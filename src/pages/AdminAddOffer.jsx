...
function AdminAddOffer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3000/api/offers', formDataToSend, {
        headers: {
  ...
  return (
    <>
      ...
      <div className="admin-add-offer-page">
        <Container>
          <div className="page-header">
            <h1 className="page-title">Add New Offer</h1>
            <p className="page-subtitle">Create attractive offers for your customers</p>
          </div>
