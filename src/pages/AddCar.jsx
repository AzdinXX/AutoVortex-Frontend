...
function AddCar() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:3000/new-cars', {
        ...formData,
        user
      });
      setSuccess(res.data);
        ...
        <Card className="addcar-card p-4" style={{ width: '600px' }}>
          <Card.Body>
            <div className="text-center mb-4">
              ...
              <h3 className="fw-bold mb-2" style={{ color: '#60a5fa', letterSpacing: '1px' }}>Add a New Car</h3> {/* Lighter blue title */}
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group className="mb-3" controlId="model">
                ...
                <Form.Control type="text" name="model" onChange={handleChange} required />
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="price_per_day">
                ...
                <Form.Control type="number" name="price_per_day" onChange={handleChange} required />
              </Form.Group>

              <Form.Group className="mb-3" controlId="image">
                <Form.Label>Image URL</Form.Label>
                <Form.Control type="url" name="image" onChange={handleChange} required />
              </Form.Group>
